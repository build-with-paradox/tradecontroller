      ...
      return (
        <button
          ...
          className={`px-4 py-2 rounded-full text-white text-sm font-semibold cursor-pointer ${
            status === "Active" ? "bg-indigo-600 opacity-50 hover:bg-indigo-700" : "bg-gray-500 hover:bg-gray-600"
          }`}
        >
...
const VendorsandSellers = () => {
  return (
    <div className="bg-white shadow-lg border border-gray-200 rounded-lg p-2 mt-4 mx-4">
      <h1 className="text-3xl font-semibold text-gray-800 mt-2 ml-3">Vendors and Sellers Overview</h1>
      <p className="text-lg text-gray-600 mt-3 ml-3">
        📊 Here's a snapshot of <span className="text-gray-900 font-semibold">Vendors and Sellers</span>, including their status, total products, and revenue.
      </p>
...
export default VendorsandSellers;
