...
const Rejected_Sellers = () => {
  ...
  return (
    <div className="bg-white shadow-md border border-gray-200 rounded-lg p-6 mt-5 mx-4">
      <h1 className="text-2xl font-semibold text-gray-800">Rejected Sellers Applications</h1>
      <p className="text-base text-gray-600 mt-2">
        📊 Here's a snapshot of{" "}
        <span className="text-gray-900 font-semibold">All Rejected Seller Applications</span>{" "}
...
export default Rejected_Sellers;
