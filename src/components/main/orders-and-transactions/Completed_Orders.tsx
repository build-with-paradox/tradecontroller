    ...
    return (
        <>
            <div className="bg-white shadow-md border border-gray-200 rounded-lg p-6 mt-4 ml-3">
                <h1 className="text-xl font-semibold text-gray-800">✅ Completed Orders</h1>
                <p className="text-sm text-gray-600 mt-2">
                    Here's a snapshot of <span className="text-gray-900 font-semibold">✅ Completed Orders</span> 📦 with 🆔 order ID, 💳 payment status, 🏷️ payment type, 📦 product count, and 💰 total amount.
                </p>
